...
<div id ="container" class="container-fluid p-3">
    ...
    <div class="title">
        <h1>Enjoy your English Life</h1>
        <p>あなたに合ったリスニングコンテンツが見つかる</p>
...
<section class="about">
    ...
    <div class="detail">
        <p>英語を勉強する理由は人それぞれです。その目的次第で学び方は違いますし、ゴールを逆算した学習が必要になります。
            <br>しかし、どのようなやり方でも共通することは、英語を「楽しむ」ことが最重要だということ。<br>
            このサイトでは、この世の中にあふれるたくさんのリスニングコンテンツから、あなたの目的や趣味趣向にあったコンテンツを検索することができます。 
        </p>
    </div>
</section>
@endsection